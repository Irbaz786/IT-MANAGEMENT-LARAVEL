						...
						<div class="col-12 item">
							<div class="row items">
								<div class="col-md-6 col-xl-4 col-12 item">
									<a href="ex" class="iitem item-style iitem-hover">
										...
										<h2 class="iitem-heading item-heading-large">Web Development</h2>
								...
								<div class="col-md-6 col-xl-4 col-12 item">
									<a href="ex" class="iitem item-style iitem-hover">
										...
										<h2 class="iitem-heading item-heading-large">Fraud & Security</h2>
								...
								<div class="col-md-6 col-xl-4 col-12 item">
									<a href="ex" class="iitem item-style iitem-hover">
										...
										<h2 class="iitem-heading item-heading-large">Advanced Analytics</h2>
								...
								<div class="col-md-6 col-xl-4 col-12 item">
									<a href="ex" class="iitem item-style iitem-hover">
										...
										<h2 class="iitem-heading item-heading-large">Programming</h2>
										<div class="iitem-desc">We embrace holistic development and support for employees with the aim.</div>
									</a>
								</div>
								<div class="col-md-6 col-xl-4 col-12 item">
