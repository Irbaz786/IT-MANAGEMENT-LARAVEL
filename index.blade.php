...
<div class="clearfix"></div>
  ...
  <script src="assetsA/js/jquery.min.js"></script>
  <script src="assetsA/js/popper.min.js"></script>
  <script src="assetsA/js/bootstrap.min.js"></script>
	
 <!-- simplebar js -->
  <script src="assetsA/plugins/simplebar/js/simplebar.js"></script>
  <!-- sidebar-menu js -->
  <script src="assetsA/js/sidebar-menu.js"></script>
  <!-- loader scripts -->
  <script src="assetsA/js/jquery.loading-indicator.js"></script>
  <!-- Custom scripts -->
  <script src="assetsA/js/app-script.js"></script>
  <!-- Chart js -->
  
  <script src="assetsA/plugins/Chart.js/Chart.min.js"></script>
 
  <!-- Index js -->
  <script src="assetsA/js/index.js"></script>
