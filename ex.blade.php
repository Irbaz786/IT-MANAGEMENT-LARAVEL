  ...
  <body>
    <div class="container">
      ...
      <form action="{{ route('image.store') }}" method="post" enctype="multipart/form-data">
        ...
        <input type="email" id="email" name="meg" class="form-control @error('meg') is-invalid @enderror" value="{{old('meg')}}" required>
        ...
        @if ($errors->has('meg'))
        <div class="invalid-feedback">{{ $errors->first('meg') }}</div>
        @endif
        <br>
